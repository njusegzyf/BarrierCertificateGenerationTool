function [lp, solveRes, lpVer, solveResVer, resNorms] = runLp4HybridExample1WithDegreeAndRangeCandidates()
...
[vars, f, eps, g_theta, g_psy, g_zeta] = getLp4HybridExample1Problem();
...
ranges = [1, 0.5, 0.1]; % [1, 0.5, 0.3, 0.15, 0.1];
