function results = verifyLp4EmsoftBiologicalModel2WithDifferentRegions()
...
results = [];
    ...
    function processRegionCombinations(currentPos)
        if (currentPos == varsLen + 1)
            ...
            % run and verify
            lpVer = lp4.LinearProgram4Verification3.createWithRou(vars, f, eps, theta, psy, zeta, pLambdaDegree, initPhy);
