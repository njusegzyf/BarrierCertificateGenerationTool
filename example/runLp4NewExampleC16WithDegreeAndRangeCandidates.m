function [lp, solveRes, lpVer, solveResVer, resNorms] = runLp4NewExampleC16WithDegreeAndRangeCandidates()
...
% get the problem
[vars, f, eps, g_theta, g_psy, g_zeta] = getLp4NewExampleC16Problem();
