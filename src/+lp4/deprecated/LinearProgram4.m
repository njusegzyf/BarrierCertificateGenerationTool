classdef LinearProgram4
    %LinearProgram4 A linear program.
    ...
    methods
        ...
        function this = LinearProgram4(indvarsArg)
        ...
        function this = setThetaConstraint(this, theta)
            ...
            %             mons = monomials(this.indvars, 0 : de);
            %             for i = 1 : 1 : length(mons)
            %                 % FIXME
            %                 constraint1 = constraint1 - this.rouVar * mons(i);
            %             end
        ...
        function this = setPsyConstraint(this, psy)
            ...
            for i = 1 : 1 : length(mons)
                % FIXME
                constraint2 = constraint2 - this.rouVar * mons(i);
            end
        ...
        function this = setZetaConstraint(this, zeta)
            ...
            %             for i = 1 : 1 : length(mons)
            %                 % FIXME
            %                 constraint3 = constraint3 - this.rouVar * mons(i);
            %             end
        ...
        function [this, solveRes] = solve1And3(this)
            ...
            unsedVarStart = this.getRouIndex() - 1;
            unsedVarLength = 1 + this.getPLambdaCoefficientLength() + this.getWLength();
            unsedVarAeq = zeros(unsedVarLength, length(this.decvars));
            for k = 1 : 1 : unsedVarLength
                unsedVarAeq(k, unsedVarStart + k) = 1;
            end
            unsedVarbeq = zeros(unsedVarLength, 1);
